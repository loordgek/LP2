...
public abstract class References {
    ...
    public static final String VERSION = "1.10.2-InDev";
    ...
    public static final String NAME_MODULE_ITEM_ENTRY = MODID + ".module_item_entry";
    ...
    public static final String RN_MODULE_ITEMENTRY = "module_itementry";
